...
Animating in GeckoLib is almost exactly the same as how you would animate for a bedrock entity. There are currently no GeckoLib specific video tutorials, but you can watch this bedrock animation [tutorial](https://youtu.be/iu2L-LNi8gs) instead:

[![Minecraft Modding Tutorial 1.15](http://img.youtube.com/vi/iu2L-LNi8gs/0.jpg)](https://youtu.be/iu2L-LNi8gs "Minecraft Modding Tutorial 1.15")
