![geckolib](https://i.softwarelocker.net/geckolib.png)
...
Please see the [Getting Started guide](2.0.0) for detailed installation instructions per modding framework.

## Documentation
GeckoLib provides detailed documentation in the form of a [Wiki](2.0.0) and [Javadocs](http://geckolib.bernie.software/javadocs/). GeckoLib is currently available for Forge 1.12, 1.15, 1.16 and Fabric 1.15 and 1.16.
